...
export const aStar = (grid: INode[][], startNode: INode, finishNode: INode) => {
  ...
  startNode.estimatedDistanceToEnd = calculateManhattanDistance(startNode, finishNode);
  ...
  while (!nodesToVisit.isEmpty()) {
    ...
    for (const neighbor of neighbors) {
      ...
      // F-Store = G + H
      neighbor.estimatedDistanceToEnd = tentativeDistanceToNeighbor + calculateManhattanDistance(neighbor, finishNode);
